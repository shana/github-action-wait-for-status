...
final class App
{
    ...
    public function wait(string $repository, string $ignoreActions, string $watchActions, float $checkInterval, string ...$shas): PromiseInterface
    {
        ...
        return unwrapObservableFromPromise((new LookUpRepository($repository, $this->logger))($this->github)->then(
            ...
            new GetStatusChecksFromCommits(Loop::get(), $this->logger, $ignoreActions, $watchActions, $checkInterval)
        )->map(
